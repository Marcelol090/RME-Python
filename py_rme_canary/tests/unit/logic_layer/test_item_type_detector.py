...
class TestItemCategoryDetection:
    ...
    def test_detect_carpet_category(self):
        ...
        item = Item(id=6357)  # Carpet range (start)
...
class TestHelperMethods:
    ...
    def test_can_select_brush_for_wall(self):
        ...
        if hasattr(ItemTypeDetector, "can_select_brush"):
            wall = Item(id=1050)
            # Pass ItemCategory or Item depending on what's expected.
            # Updated implementation supports Item via automatic categorization.
