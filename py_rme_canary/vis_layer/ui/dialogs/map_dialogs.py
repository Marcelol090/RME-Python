...
class MapPropertiesDialog(QDialog):
    ...
    def _create_files_tab(self) -> QWidget:
        ...
        # Spawn monsters XML
        self.spawn_monsters_path = self._create_file_field(
            "Spawn Monsters File:",
            "XML Files (*.xml)"
        )
        ...
        # Spawn NPCs XML
        self.spawn_npcs_path = self._create_file_field(
            "Spawn NPCs File:",
            "XML Files (*.xml)"
        )
        ...
        # Houses XML
        self.houses_path = self._create_file_field(
            "Houses File:",
            "XML Files (*.xml)"
        )
...
class AboutDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        # Description
        desc = QLabel(
            "Modern Python port of Remere's Map Editor\n"
        ...
        # Credits
        credits = QLabel(
            "Based on Remere's Map Editor by the RME Team\n"
