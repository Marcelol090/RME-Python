...
class RecentFilesManager:
    ...
    def __init__(self, config_path: str | None = None, max_files: int = MAX_RECENT_FILES) -> None:
...
def build_recent_files_menu(parent_menu: object, on_file_selected: callable) -> None:
    ...
    try:
        ...
        for i, (display, path) in enumerate(items):
            ...
            action.setData(path)
            action.triggered.connect(lambda checked, p=path: on_file_selected(p))
