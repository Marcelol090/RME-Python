...
class ConfigurationManager:
    ...
    def load_brushes(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            with open(self._definitions.brushes_json, 'r', encoding='utf-8') as f:
    ...
    def get_brush_by_name(self, brush_name: str) -> Optional[Dict[str, Any]]:
